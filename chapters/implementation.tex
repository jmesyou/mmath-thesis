...
\end{figure}
Figure \ref{impl:local-global-node} provides the implementations of \scalainline{ReadGlobalNode} and \scalainline{ReadLocalNode}.
...
If a \scalainline{ReturnException} is not caught, the callee did not contain a \scalainline{Return} tree.
