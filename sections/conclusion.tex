...
In this thesis we have evaluated \textsc{TastyTruffle} on simply but nonetheless difficult to specialization data structures exhibiting bulk memory access as well random heap access.
