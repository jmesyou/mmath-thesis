...
Compile-time evaluation in Zig exposes constant folding as a useful abstraction.
...
For example, run-time type switches over types without needing reflection are possible in the context of inline reified types.
